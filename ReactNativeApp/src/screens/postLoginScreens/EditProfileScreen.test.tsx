...
const renderScreen = () => {
    const [route, navigation] = [{
        ...
        params: { username: initialUsername, email: initialEmail, firstName: initialFirstName, lastName: initialLastName},
    }, {
        navigate: jest.fn(),
    }] as const;
    ...
    return render(
        <EditProfileScreen 
            ...
            navigation={navigation as unknown as StackNavigationProp<MyStackParamsList, "EditProfileScreen">} 
        />
    );
};
...
describe('ProfileScreen', () => {
    ...
    it('should update states when inputs are changed', () => {
        ...
        const { setUsername, setEmail, setFirstName, setLastName } = useEditProfileController(initialUsername, initialEmail, initialFirstName, initialLastName);
    ...
    it('should call the correct functions when buttons are pressed', () => {
        ...
        const { handleGoBack, handleEditProfileSubmit } = useEditProfileController(initialUsername, initialEmail, initialFirstName, initialLastName);
