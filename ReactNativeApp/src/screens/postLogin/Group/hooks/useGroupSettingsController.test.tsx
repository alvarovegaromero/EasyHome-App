...
describe('useGroupSettingsController', () => {
    ...
    describe('confirmAndDeleteGroup', () => {
        ...
        describe('deleteGroup', () => {
            ...
            it('should delete groupId when delete is succesful', async () => { //maybe can be removed
                mockSuccesfulFetch({});
    ...
    describe('copyJoinCodeToClipboard', () => {
        it('should copy join code to clipboard', async () => {
            ...
            expect(require('@react-native-clipboard/clipboard').setString).toHaveBeenCalledWith('dummy_code');
        });
