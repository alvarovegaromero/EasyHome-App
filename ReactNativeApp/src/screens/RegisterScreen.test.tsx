...
describe('ResetPasswordScreen', () => {
    ...
    it('should update state when input is changed', () => {
        ...
        const { setUsername, setEmail, setPassword, setConfirmPassword, setFirstName, setLastName } = useRegisterController();
    ...
    it('should call the correct functions when buttons are pressed', () => {
        ...
        const { handleRegisterSubmit, navigateLoginScreen, navigateResetPasswordScreen } = useRegisterController();
